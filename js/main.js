;(function () {
	...
	var countdown = function() {
		...
		var deadline = 'July 2 2022 12:00:00 GMT+0100';
		if (countdown){
	...
	var collapseEventsInfo = function() {
		$('#info-accordion').on('show.bs.collapse hide.bs.collapse', function (e) {
			var elemId = $(e.target).attr('id') + '0';

			$('#info-accordion-img .collapse').collapse('hide');
			$('#'+elemId).collapse('toggle');
		});
	}
